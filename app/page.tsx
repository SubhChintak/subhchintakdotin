  ...
  bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)]
   ...
   md:px-16
          ...
          <div className="md:flex items-center justify-between gap-y-4 my-10 gap-x-28 mx-auto">
            <div className="md:w-2/5">
              <h1 className="text-2xl font-medium text-gray-600 w-4/5">
                Trusted by brands accross North-East India
              </h1>
            ...
            <section className="overflow-hidden mt-10 md:w-4/5">
              <InfiniteMovingLogos
                ...
                items={[
                  {
                    logo: "/logo/subhchintak-logo.png",
                    name: "Logo",
                  },
                  {
                    logo: "/logo/subhchintak-logo.png",
      ...
      <Element name="services">
        ...
        <p className="font-medium md:text-center py-4 md:w-1/2 mx-auto text-xl md:text-2xl text-gray-500">
        ...
        <main className="md:flex items-center justify-center space-y-6 md:space-y-0 md:gap-x-20 xl:w-4/5 2xl:w-[68%] mx-auto px-6 md:px-0">
          ...
          <div className="flex flex-col gap-y-5 md:w-1/2">
            <h1 className="text-lg md:text-2xl ">
              &quot;We&apos;ve been working with SubhChintak since last year and
